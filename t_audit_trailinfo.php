...
class ct_audit_trail extends cTable {
	...
	function __construct() {
		...
		// datetime
		$this->datetime = new cField('t_audit_trail', 't_audit_trail', 'x_datetime', 'datetime', '`datetime`', ew_CastDateFieldForLike('`datetime`', 11, "DB"), 135, 11, FALSE, '`datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->datetime->EditValue = ew_FormatDateTime($this->datetime->CurrentValue, 11);
