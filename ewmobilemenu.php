...
$RootMenu->AddMenuItem(31, "mmi_pembagian1", $Language->MenuPhrase("31", "MenuText"), "pembagian1list.php", 65, "", AllowListMenu('{035CBF11-745C-4982-814A-B6768131C8FC}pembagian1'), FALSE, FALSE);
$RootMenu->AddMenuItem(32, "mmi_pembagian2", $Language->MenuPhrase("32", "MenuText"), "pembagian2list.php", 65, "", AllowListMenu('{035CBF11-745C-4982-814A-B6768131C8FC}pembagian2'), FALSE, FALSE);
$RootMenu->AddMenuItem(33, "mmi_pembagian3", $Language->MenuPhrase("33", "MenuText"), "pembagian3list.php", 65, "", AllowListMenu('{035CBF11-745C-4982-814A-B6768131C8FC}pembagian3'), FALSE, FALSE);
