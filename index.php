...
class cdefault {
	...
	function Page_Main() {
		...
		if ($Security->AllowList(CurrentProjectID() . 'v_shift'))
			$this->Page_Terminate("v_shiftlist.php");
		if ($Security->AllowList(CurrentProjectID() . 'v_lembur'))
			$this->Page_Terminate("v_lemburlist.php");
